  ...
  return (
    <label className="relative inline-flex min-h-11 items-center">
      ...
      <select
        ...
        className="appearance-none rounded-2xl border-2 border-[var(--border-card)] bg-[var(--bg-card)] py-2 pl-4 pr-10 font-display text-lg text-[var(--text-primary)] outline-none focus:border-[var(--accent-green)]"
      >
        {options.map((opt) => (
